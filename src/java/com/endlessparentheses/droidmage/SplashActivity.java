package com.endlessparentheses.droidmage;
...
import com.endlessparentheses.droidmage.R;
...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("com.endlessparentheses.droidmage.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("com.endlessparentheses.droidmage.MainActivity");
